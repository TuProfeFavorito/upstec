...
function wpdocs_codex_fonts_init() {
    $labels = array(
        'name'                  => _x( 'fonts', 'Post type general name', 'textdomain' ),
        'singular_name'         => _x( 'font', 'Post type singular name', 'textdomain' ),
        'menu_name'             => _x( 'fonts', 'Admin Menu text', 'textdomain' ),
        ...
        'edit_item'             => __( 'Edit font', 'textdomain' ),
        'view_item'             => __( 'View font', 'textdomain' ),
        'all_items'             => __( 'All fonts', 'textdomain' ),
        'search_items'          => __( 'Search fonts', 'textdomain' ),
        'parent_item_colon'     => __( 'Parent fonts:', 'textdomain' ),
        'not_found'             => __( 'No fonts found.', 'textdomain' ),
        'not_found_in_trash'    => __( 'No fonts found in Trash.', 'textdomain' ),
        ...
        'filter_items_list'     => _x( 'Filter fonts list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'textdomain' ),
        'items_list_navigation' => _x( 'fonts list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'textdomain' ),
        'items_list'            => _x( 'fonts list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'textdomain' ),
    );
...
add_action( 'init', 'wpdocs_codex_fonts_init' );
